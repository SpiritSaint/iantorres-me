...
exports.buildXMLandRSS = exports.writeRoutesToStatic = exports.getConfig = undefined;
...
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; /* eslint-disable import/no-dynamic-require, react/no-danger, no-cond-assign */
...
var normalizeRoutes = function normalizeRoutes(routes) {
  ...
  var recurse = function recurse(route) {
    ...
    var path = (0, _shared.pathJoin)(parent.path, route.path);
...
var writeRoutesToStatic = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee3(_ref3) {
    ...
    var userConfig, HtmlTemplate, Comp;
                    ...
                    switch (_context2.prev = _context2.next) {
                      ...
                      case 34:
                        ...
                        html = '<!DOCTYPE html>' + (0, _server.renderToString)(_react2.default.createElement(
                          HtmlTemplate,
                          { staticMeta: staticMeta, Html: Html, Head: Head, Body: Body },
                        ...
                        htmlFilename = _path2.default.join(_paths.DIST, route.path, 'index.html');
